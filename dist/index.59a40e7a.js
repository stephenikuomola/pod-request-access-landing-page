...
class FormComponent {
    ...
    #handleUserValueInput() {
        if (this.#email.validity.valid) this.#error.innerHTML = ``;
    ...
    #showErrorMessage() {
        if (this.#email.validity.valueMissing) this.#error.innerHTML = `Oops! Please add your email`;
        if (this.#email.validity.typeMismatch) this.#error.innerHTML = `Oops! Please check your email`;
    }
}
new FormComponent();

},{}]},["7ZoMj","8lRBv"], "8lRBv", "parcelRequire7acf")
